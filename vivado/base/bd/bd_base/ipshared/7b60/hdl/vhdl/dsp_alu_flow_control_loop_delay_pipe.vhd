...
entity dsp_alu_flow_control_loop_delay_pipe is
port (
    ap_clk             : in  std_logic;
    ap_rst             : in  std_logic;
...
end entity dsp_alu_flow_control_loop_delay_pipe;

architecture behav of dsp_alu_flow_control_loop_delay_pipe is
